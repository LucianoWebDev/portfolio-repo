    ...
    let sum = 0;
      ...
      if(nuAN === ''){
        document.getElementById('resultAN').innerHTML = 'Insert a number.. 🙄'
          ...
          if(sum < 10){
            document.getElementById('resultAN').innerHTML = 'All numbers < 10 are \'armstrong numbers\'. Try a higher one ⏫'
          }else{
            document.getElementById('resultAN').innerHTML = 'This is an \'armstrong number\' 🥳'
          }
      }else{
        document.getElementById('resultAN').innerHTML = 'Nope, no \'armstrong number\' here 🚫'
      }
});
